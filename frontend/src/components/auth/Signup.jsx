...
const Signup = () => {
  ...
  const submitHandler = async(e)=>{
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_USER_API_ENDPOINT}/register`,formData,{
        ...
        <div className='flex items-center justify-center max-w-7xl mx-auto'>
            <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                ...
                <div className = 'my-2 mb-5'>
                  ...
                  <Input type="number" value={input.phoneNumber} name="phoneNumber" onChange={changeEventHandler} placeholder="Enter your Number"/>
                </div>
