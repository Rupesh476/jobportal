...
import { setUser } from '../redux/authSlice.js' // Adjust the path based on your project structure
        ...
        <form onSubmit={submitHandler}>
          <div className='grid gap-4 py-4'>
            ...
            <div className='grid grid-cols-4 items-center gap-4'>
              ...
              <Input id='phoneNumber' name='phoneNumber' type='number' value={input.phoneNumber} onChange={changeEventHandler} className='col-span-3' />
            </div>
            <div className='grid grid-cols-4 items-center gap-4'>
          ...
          <DialogFooter>
            {
              loading ? (
                ...
                <Button type='submit' className='w-full cursor-pointer'>Update</Button>
              )
            }
          </DialogFooter>
        </form>
